# Storefront category snapshot

## Purpose

Versioned category tree snapshot and sync script for storefront navigation resilience when live Payload CMS is unavailable, without embedding static taxonomy in application source.
