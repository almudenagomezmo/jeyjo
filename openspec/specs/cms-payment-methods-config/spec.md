# CMS payment methods configuration

## Purpose

Staff-configurable B2C payment method toggles and transfer instructions exposed via Payload global `paymentSettings` (alcance §1.10).
