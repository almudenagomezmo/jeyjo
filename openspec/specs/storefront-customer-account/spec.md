...
Authenticated B2C customer account area (`/cuenta`), pending-validation messaging, profile summary, customer orders with repeat-to-cart, and legacy route aliases for acceptance tests.
