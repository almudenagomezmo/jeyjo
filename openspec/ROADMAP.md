...
| 15 | `home-segmented-banners` | 9, 10 | Alcance §1.6, US-02 | Pendiente | — |
| 16 | `auth-registration-area-cliente` | 2, 3 | RF-001, RF-004, US-04, US-07 | Pendiente | — |
...
| 21 | `pim-seo-dual-images` | 3, 5 | RF-024, US-16 | Pendiente | — |
| 22 | `portal-b2b-shell` | 16, 6 | RF-001, RF-011, US-07 | Pendiente | — |
...
**Siguiente cambio recomendado:** #10 `plp-faceted-listing` (dependencias #6, #7, #9 completadas). Archivar #8 `stock-multisource-adapters` si aún está en `openspec/changes/`.
