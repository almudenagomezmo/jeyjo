# wishlist-stock-alert-dispatch

## Purpose

Post-stock-sync detection and per-profile notification dispatch for wishlist stock alerts (change #35).
...
- **THEN** `payload.href` is `/p/boligrafo-azul` or the canonical PDP route for that SKU
