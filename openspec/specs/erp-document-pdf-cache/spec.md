# ERP document PDF cache

## Purpose

On-demand cache of ERP document PDFs in Supabase `private-documents` with signed URL or streaming download for B2B Contabilidad.
...
### Requirement: Staff-uploaded PDFs served in web-native mode
