...
B2B intranet view at `/intranet/precios` for negotiated special prices and active group offers (RF-020, US-14), including validity status and price review requests.
