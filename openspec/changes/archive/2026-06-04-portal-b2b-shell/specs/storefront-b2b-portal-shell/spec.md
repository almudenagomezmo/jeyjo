...
Non-implemented intranet sections SHALL render a structured scaffold with business-oriented copy and reference to the future OpenSpec change that will deliver functionality, without fetching ERP data.

#### Scenario: Histórico de pedidos scaffold

- **WHEN** a user opens `/intranet/pedidos`
