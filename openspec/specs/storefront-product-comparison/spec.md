# Storefront product comparison

## Purpose

PLP product comparison for anonymous visitors (US-06): select up to 3 SKUs from faceted listings, compare attributes side-by-side at `/comparar`, and add to cart from the comparison table.
