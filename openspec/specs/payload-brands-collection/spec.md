# Payload brands collection

## Purpose

Payload CMS collection for commercial manufacturer brand identity (e.g. BIC, HP), separate from logistics suppliers, with optional product relationships and staff-only access.
