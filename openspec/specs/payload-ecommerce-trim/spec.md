# Payload ecommerce trim

## Purpose

Adjustments to the Payload ecommerce plugin template for Jeyjo: optional Stripe, disabled variants by default, catalog-media storage, and Spanish admin navigation groups.
