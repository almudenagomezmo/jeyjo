...
Payload global `footerSettings`, public `footer` block in system config API, admin hub access, and audit for storefront footer configuration (change footer-eva-omnichannel-complete).
