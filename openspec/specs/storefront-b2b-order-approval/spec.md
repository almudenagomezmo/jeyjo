# Storefront B2B order approval

## Purpose

Company-level order approval queue for subusers with `ordersRequireApproval` before orders reach Jeyjo OMS (US-12 CA3, change #26).
